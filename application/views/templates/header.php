...
<body>
  <div class="navbar navbar-expand-lg fixed-top navbar-dark bg-primary">
    <div class="container">
      <a href="<?= base_url() ?>" class="navbar-brand">Fuzzy Tsukamoto Hehe</a>
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        ...
        <ul class="nav navbar-nav ml-auto">
          <li class="nav-item">
            <a class="nav-link" href="https://wrapbootstrap.com/?ref=bsw" target="_blank">faizinahmad06@gmail.com</a>
          </li>
        </ul>
